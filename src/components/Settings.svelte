...
<Tabs>
	...
	<!-- General -->
	<TabPanel>
		<AccordionPanel accordionTitle="Appearance">
			<div class="mb-2">
				<ThemeButtons />
			</div>
		...
		<AccordionPanel accordionTitle="Shortcuts">
			<div class="block mb-2">
				<Toggle
	...
	<!-- Clock -->
	<TabPanel>
		<AccordionPanel accordionTitle="Displays">
			<div class="block mb-2">
		...
		{#if $session.settings.clock.displays.primary == 'analog'}
			<AccordionPanel accordionTitle="Analog">
				<h3>Face</h3>
		...
		{#if $session.settings.clock.displays.primary != 'analog' || $session.settings.clock.displays.secondary != 'none'}
			<AccordionPanel accordionTitle="Digital Datetime">
				<div class="block mb-2">
					<div class="block mb-2">
					...
					<Modal bind:this={datetimeFormatModal} title="Datetime Formatting" icon="table">
						...
						<table>
							...
							<tbody>
								...
								<tr
									><td>dddd</td><td>Sunday-Saturday</td><td>The name of the day of the week</td></tr
								>
