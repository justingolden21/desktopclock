<script>
	...
	const icons = {
		...
		'play': {
			path: `m14.752 11.168-6.394-4.264a2 2 90 00-3.11 1.668v8.526a2 2 90 003.11 1.664l6.394-4.264a2 2 90 000-3.328z`
		},
		'pause': {
			path: `m10 9v12m8-12v12`
		},
		'stop': {
			path: `m9 10a2 2 90 012-2h8a2 2 90 012 2v8a2 2 90 01-2 2h-8a2 2 90 01-2-2v-8z`
		}
	};
	$: icon = icons[name];
</script>
